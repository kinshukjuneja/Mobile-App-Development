...
public class HoroscopeNearMeFragment extends HoroscopeFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fhpTitle.setText("People near me");

        RecyclerView recyclerView = view.findViewById(R.id.fhpRV);
        recyclerView.setAdapter(new HoroscopePeopleAdapter(false, recyclerView, (HoroscopeMainActivity)getActivity()));
