...
public class HoroscopeAcknowledgmentFragment extends HoroscopeFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fhpTitle.setText("Acknowledgment");

        RecyclerView recyclerView = view.findViewById(R.id.fhpRV);
        recyclerView.setAdapter(new HoroscopeDevelopmentAdapter(true));
